...
class General(commands.Cog):
    ...
    async def set_target_channel(
        ...
        was_new = self.channel_config.add_channel(interaction.guild.id, target_channel.id)
    ...
    async def remove_target_channel(
        ...
        was_removed = self.channel_config.remove_channel(interaction.guild.id, target_channel.id)
    ...
    async def list_target_channels(self, interaction: discord.Interaction) -> None:
        ...
        channel_ids = self.channel_config.get_channels(interaction.guild.id)
    ...
    async def clear_target_channels(self, interaction: discord.Interaction) -> None:
        ...
        count = self.channel_config.clear_guild(interaction.guild.id)
