"""Match data models for Discord message construction.

These models represent the pre-processed match data that an external process
provides to the bot. The bot is not responsible for fetching or calculating
this data — it only formats and publishes Discord messages.
"""
...
class MatchData:
    """
    Complete match data for Discord message construction.
